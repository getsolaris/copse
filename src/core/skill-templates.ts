...
const referenceSpecs: ReferenceSpec[] = [
  ...
  },
  {
    ...
    configKeys: [
      "`updates.enabled` — Enable interactive launch-time and TUI update prompts",
...
function generateConfigSchemaContent(): string {
  return [
    ...
    "| Key | Type | Default | Description |",
    "|-----|------|---------|-------------|",
    "| `enabled` | boolean | `true` | Enable interactive launch-time and TUI update prompts. Explicit `copse update` still works when disabled. |",
